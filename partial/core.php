...
<body>
  <div id="wrapper">
    ...
    <div id="photoViewer">
      ...
      <div id="photoViewerControls">
        <button type="button" class="pv-btn" data-act="zoom-out" title="Zoom arrière"><i class="fas fa-search-minus"></i></button>
        <button type="button" class="pv-btn" data-act="zoom-in" title="Zoom avant"><i class="fas fa-search-plus"></i></button>
        <button type="button" class="pv-btn" data-act="rot-left" title="Tourner à gauche"><i class="fas fa-undo"></i></button>
        <button type="button" class="pv-btn" data-act="rot-right" title="Tourner à droite"><i class="fas fa-redo"></i></button>
        <button type="button" class="pv-btn" data-act="reset" title="Réinitialiser"><i class="fas fa-compress-arrows-alt"></i></button>
      </div>
