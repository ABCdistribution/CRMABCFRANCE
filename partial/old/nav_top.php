<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="<?php echo URL;?>" class="nav-link">Accueil</a>
    </li>
    <?php /*
    <li class="nav-item d-none d-sm-inline-block">
  ...
  <ul class="navbar-nav ml-auto">
        ...
        <a href="#" class="dropdown-item">
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <p class="text-sm">Problème stock sur produit...</p>
              <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> il y à 4h</p>
            </div>
          </div>
          <!-- Message End -->
        </a>
        ...
        <a href="#" class="dropdown-item">
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <p class="text-sm">Problème commande n°464...</p>
              <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> il y à 6h</p>
            </div>
          </div>
          <!-- Message End -->
        </a>
        ...
        <a href="#" class="dropdown-item">
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <p class="text-sm">Réception d'une comannde...</p>
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <div class="dropdown-divider"></div>
        <a href="#" class="dropdown-item">
          <i class="fas fa-users mr-2"></i> 8 interventions
