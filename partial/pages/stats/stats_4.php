<div class="filters">
  ...
  <label class="mr-5"><strong><i class="fas fa-filter mr-2"></i> <?php echo l('stat-filtre-nom');?> : </strong></label>
    ...
    <div class="input-group mr-2">
      ...
      <select class="form-control" name="fp_raison">
        <?php
        $reasons = [0=> l("stats-raisons")];
        $reasons = $reasons + core::getListReason('FRANCO_NO');
        $reasons["autre"] = l("stats-autres-raisons");
        foreach( $reasons as $k=>$e) {
          $s = ( isset($_POST['fp_raison']) && $_POST['fp_raison'] == $k ? 'selected' : '' );
...
<div id="statsRezWrapper" data-get="getFrancoNonAtteints"></div>
