<div class="filters">
  ...
  <label class="mr-5"><strong><i class="fas fa-filter mr-2"></i> <?php echo l('stat-filtre-nom');?> : </strong></label>
    ...
    <div class="input-group mr-2">
      ...
      <select class="form-control" name="no_cmd_reason">
        <?php
        $reasons = [0=> l("stats-raisons")];
        $reasons = $reasons + core::getListReason('VIS_SS_CMD');
        $reasons["autre"] = l("stats-autres-raisons");
        foreach( $reasons as $k=>$e) {
          //if( $k == 4 ) continue;
          $s = ( isset($_POST['no_cmd_reason']) && $_POST['no_cmd_reason'] == $k ? 'selected' : '' );
...
<div id="statsRezWrapper" data-get="getVisistesSansCommandes"></div>
