    ...
    <div class="input-group mr-2">
      ...
      <select class="form-control" name="promo">
        ...
        foreach( $promos as $k=>$e) {
          $s = ( isset($_POST['promo']) && $_POST['promo'] == $e['id_as400'] ? 'selected' : '' );
          echo '<option value="'.$e['id_as400'].'" '.$s.'>'.$e['libelle'].'  ('.$e['id_as400'].')</option>';
        }
        ?>
      </select>
    </div>
...
<div id="statsRezWrapper" data-get="getPromosVisites"></div>
