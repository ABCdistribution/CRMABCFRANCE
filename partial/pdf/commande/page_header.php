                        ...
                        <div style="font-size:10px; margin-top:5px;">
                            <table style="width:100%;" cellpadding="0" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr><td>Client :</td><td><strong>#<?php echo $cmd['client']['id_as400'];?></strong></td></tr>
                                </tbody>
                            </table>
                        </div>
                    </td>
                    <td style="width: 40%;">
                        ...
                        <div style="font-size:10px; width:100%;">
                            ...
                            <?php 
                                ...
                                if( $cmd['client']['code_postal_2'] != "" ) echo $cmd['client']['code_postal_2'].' ';
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tbody>
                                    <?php if( $cmd['commande']['no_cmd_client'] != "" ) { ?>
                                    <tr>
                                        <td style="width:120px;">N° Commande client :</td>
                                        <td><?php echo $cmd['commande']['no_cmd_client'];?></td>
                                    </tr>
                                    <?php } ?>

                                    <tr>
                                        <td style="width:120px;">N° Commande ABC :</td>
                                        <td><?php echo str_pad($cmd['commande']['id'],15,"0",STR_PAD_LEFT);?></td>
                                    </tr>
                                    <tr>
                                        <td>Date de livraison :</td>
                                        <td>
                                            <strong><?php echo core::dateOutput($cmd['commande']['date_liv_estimee']);?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Promoteur :</td>
