...
export default function Prospects() {
  const prospects = [
    ...
    },
    {
      ...
      email: "s.bernard@def.fr",
      adresse: "45 Avenue des Champs, 69000 Lyon",
      secteur: "Textile",
      statut: "Qualifié",
      valeur: "€8,500",
      dateContact: "14/01/2024",
    ...
    },
    {
      ...
      email: "i.moreau@jkl.fr",
      adresse: "12 Place du Capitole, 31000 Toulouse",
      secteur: "Services",
      statut: "Perdu",
      valeur: "€5,000",
      dateContact: "12/01/2024",
  ...
  const getStatutColor = (statut: string) => {
    const colors = {
      ...
      'Qualifié': { bg: '#dcfce7', color: '#16a34a' },
      'Prospect': { bg: '#dbeafe', color: '#2563eb' },
      'Perdu': { bg: '#fee2e2', color: '#dc2626' }
    }
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1f2937', margin: 0 }}>Prospects en cours</h1>
          <p style={{ color: '#6b7280', margin: '0.5rem 0 0 0' }}>Gérez vos prospects et opportunités commerciales</p>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {prospects.map((prospect, index) => {
                  const statutColors = getStatutColor(prospect.statut)
                  return (
                    <tr key={prospect.id} style={{ borderBottom: index < prospects.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                      <td style={{ padding: '0.75rem 1rem', fontSize: '0.875rem', color: '#1f2937' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                          ...
                          <div>
                            <div style={{ fontWeight: '500' }}>{prospect.nom}</div>
                            <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>{prospect.adresse}</div>
                          </div>
                        </div>
                      </td>
