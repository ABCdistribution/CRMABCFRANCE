...
export default function Utilisateurs() {
  const utilisateurs = [
    ...
    },
    {
      id: 4,
      nom: "Sophie Bernard",
      email: "sophie.bernard@gescom.fr",
      role: "CS",
      statut: "Actif",
      derniereConnexion: "Aujourd'hui",
      profil: "CS"
  ...
  const getRoleColor = (role: string) => {
    const colors = {
      'Administrateur': { bg: '#fef3c7', color: '#d97706' },
      'Commercial': { bg: '#dbeafe', color: '#2563eb' },
      'Promoteur': { bg: '#dcfce7', color: '#16a34a' },
      'CS': { bg: '#f3e8ff', color: '#9333ea' }
    }
    return colors[role as keyof typeof colors] || { bg: '#f3f4f6', color: '#6b7280' }
  }
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1f2937', margin: 0 }}>Gestion des Utilisateurs</h1>
          <p style={{ color: '#6b7280', margin: '0.5rem 0 0 0' }}>Gérez les utilisateurs et leurs permissions</p>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {utilisateurs.map((utilisateur, index) => {
                  const roleColors = getRoleColor(utilisateur.role)
                  return (
                    <tr key={utilisateur.id} style={{ borderBottom: index < utilisateurs.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                      <td style={{ padding: '0.75rem 1rem', fontSize: '0.875rem', color: '#1f2937' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                          ...
                          <span style={{ fontWeight: '500' }}>{utilisateur.nom}</span>
                        </div>
                      </td>
                      ...
                      <td style={{ padding: '0.75rem 1rem', fontSize: '0.875rem' }}>
                        <span style={{ 
                          ...
                          fontSize: '0.75rem',
                          fontWeight: '500',
                          backgroundColor: utilisateur.statut === 'Actif' ? '#dcfce7' : '#fee2e2',
                          color: utilisateur.statut === 'Actif' ? '#16a34a' : '#dc2626'
                        }}>
                          {utilisateur.statut}
                        </span>
                      </td>
