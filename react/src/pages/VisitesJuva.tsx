...
export default function VisitesJuva() {
  const visitesJuva = [
    {
      id: 1,
      pharmacie: "Pharmacie ABC Paris",
      ...
      specialite: "Médicaments"
    },
    {
      id: 2,
      pharmacie: "Pharmacie DEF Lyon",
      ...
      specialite: "Compléments"
    },
    {
      id: 3,
      pharmacie: "Pharmacie GHI Marseille",
    ...
    {
      id: 4,
      pharmacie: "Pharmacie JKL Toulouse",
  ...
  const getTypeColor = (type: string) => {
    const colors = {
      'Commerciale': { bg: '#dbeafe', color: '#2563eb' },
      'Suivi': { bg: '#dcfce7', color: '#16a34a' },
  ...
  return (
    <div className="page-container">
      ...
      <div className="page-header">
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1f2937', margin: 0 }}>Gestion des Visites Juva</h1>
          <p style={{ color: '#6b7280', margin: '0.5rem 0 0 0' }}>Gérez les visites pharmaceutiques Juva</p>
        </div>
        ...
        <CardContent style={{ padding: '1.5rem' }}>
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <div style={{ position: 'relative', flex: 1 }}>
              ...
              <input 
                type="text" 
                placeholder="Rechercher une visite Juva..."
                style={{ 
                  width: '100%', 
        ...
        <CardContent style={{ padding: 0 }}>
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {visitesJuva.map((visite, index) => {
                  const statutColors = getStatutColor(visite.statut)
                  const typeColors = getTypeColor(visite.type)
                  return (
                    <tr key={visite.id} style={{ borderBottom: index < visitesJuva.length - 1 ? '1px solid #f3f4f6' : 'none' }}>
                      <td style={{ padding: '0.75rem 1rem', fontSize: '0.875rem', color: '#1f2937' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                          ...
                          <span style={{ fontWeight: '500' }}>{visite.pharmacie}</span>
                        </div>
                      </td>
